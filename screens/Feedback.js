    ...
    <View style={styles.container}>
      ...
      <View style={styles.emergencyTextContainer}>
        ...
        <Text style={styles.emergencySubText}>
          Share your thoughts and help us improve! Leave your feedback and
          reviews to help us make your experience even better.
        </Text>
      </View>
      ...
      >
        <Text style={styles.startAssessmentText}>Provide Feedback</Text>
      </TouchableOpacity>
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={styles.modalHeaderText}>Feedback Form</Text>
            <ScrollView>
              <Text style={styles.questionText}>
                1. How would you rate the consultation?
              </Text>
              <TextInput
                style={[
